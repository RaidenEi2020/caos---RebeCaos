...
object Configurator:
  /**
   *
   * @param buildCmd     builds the command to run remotely
   * @param generateHtml creates the Html code for each response
   * @param remember     mentions if the user wants to see previous responses
   * @param service          is the service
